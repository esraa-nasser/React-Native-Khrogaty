...
type props={}
export default class SelectedPlaces extends Component<props>{
        ...
        {this.getAllPlaces()}
              ...
              <Footer style={{backgroundColor:'transparent',flexDirection:'row'}} > 
                            ...
                            <Button vertical  onPress={()=>{
                                ...
                                <Image source={require('./../../../Images/Icon/gfind-places.png')} style={{width:25,height:25}}/>
