...
type props={}
export default class AllRestaurants extends Component<props>{
        ...
        <Content style={{marginTop:'-10%'}}>
          ...
          <Footer style={{backgroundColor:'transparent',flexDirection:'row'}} > 
                            ...
                            <Button vertical  onPress={()=>{
                                ...
                                <Image source={require('./../../../Images/Icon/grestaurants.png')} style={{width:25,height:25}}/>
